...
import { maxTeams } from '@/domain/discipline-rules';
import { canWithdraw, projectStage } from '@/domain/project-lifecycle';
import type { Project } from '@/domain/types';
import { useDiscipline } from '@/features/disciplines/hooks/use-disciplines';
import { paths } from '@/routes/paths';
import { pluralize } from '@/utils/format';
import { useUpdateTeams, useWithdrawProject } from '../hooks/use-projects';
