...
import { emptyPlanSections, isPlanLocked, nextMilestone } from '@/domain/project-lifecycle';
import type { IsoDate, PlanSection, Project } from '@/domain/types';
import { useCopyToClipboard } from '@/hooks/use-copy-to-clipboard';
import { cn } from '@/utils/cn';
import { joinWithAnd } from '@/utils/format';
import { useCompleteMilestone, useUpdatePlanSection } from '../hooks/use-projects';
import { MILESTONE_COPY } from '../utils/project-presentation';
