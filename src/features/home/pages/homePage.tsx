...
import { useAccount, useUpdateAccount } from '@/features/account/hooks/useAccount';
...
import { useCurrentDisciplines } from '@/features/disciplines/hooks/useDisciplines';
...
import { MILESTONE_COPY, milestoneDateLine } from '@/features/projects/utils/projectPresentation';
