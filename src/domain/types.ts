...
/** Só aparece para quem já tem projeto com a organização (regra 4 do docs/fluxos.md). */
...
export interface OrganizationHistoryEntry {
  ...
  teacherName: string;
  /** Texto do encerramento do projeto (regra 8): o que ficou com a organização. */
  result: string;
}
...
export type DemandStatus = 'open' | 'in-project';
