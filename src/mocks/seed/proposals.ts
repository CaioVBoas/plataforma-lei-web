...
/** Só existem propostas de demandas vinculadas; as registradas já viraram projetos em execução. */
export const PROPOSALS: Proposal[] = [
  {
    id: 'pr1',
    title: 'Estoque de doações visível às instituições atendidas',
    partnerName: 'Mesa Brasil Recife',
    originSummary: 'Instituições não sabem o que há no estoque de doações antes de ir buscar',
    demandId: 'mesa',
    disciplineId: 'ds',
    disciplineName: 'Desenvolvimento de Software',
    status: 'registered',
    archived: false,
    lastEditedOn: '27/07/2026',
    generatedAt: '22/07/2026 às 10:14',
    waitingDays: 0,
    registeredOn: '28/07/2026',
    plannedTeams: 2,
    teamSize: '4 a 5',
    projectId: 'p1',
    sections: generateSections('mesa'),
    workload: generateWorkload('mesa'),
  },
  {
    id: 'pr2',
    title: 'Registro contínuo de atendimento das jovens acolhidas',
    partnerName: 'Casa de Passagem',
    originSummary: 'Histórico de atendimento em fichas de papel se perde quando a equipe muda',
    demandId: 'casa',
    disciplineId: 'es1',
    disciplineName: 'Engenharia de Software 1',
    status: 'registered',
    archived: false,
    lastEditedOn: '29/07/2026',
    generatedAt: '24/07/2026 às 15:40',
    waitingDays: 0,
    registeredOn: '30/07/2026',
    plannedTeams: 2,
    teamSize: '3 a 4',
    projectId: 'p2',
    sections: generateSections('casa'),
